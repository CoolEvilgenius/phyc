...
library(ggplot2)
setwd("/Users/timread/R-projects/visa-gwas/scripts")
source('./visa_gwas_functions.R')

###############################################################################

SNP <- "../data/genotype.txt"
MIC <- "../data/phenotype.txt"
...
RT_PATH <- "/usr/local/ROADTRIPS/ROADTRIPS"
...
rt <- run_roadtrips(RT_DIR,RT_PATH)
